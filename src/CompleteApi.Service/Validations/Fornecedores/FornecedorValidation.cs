...
using CompleteApi.Domain.Models.Enums;
using CompleteApi.Service.Validations.Fornecedores.Documentos;
using FluentValidation;

namespace CompleteApi.Service.Validations.Fornecedores
{
